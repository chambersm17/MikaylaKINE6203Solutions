...
helpURL=web('http://www.mathworks.com', '-browser')


% 2. What does the command 'clear all' do?
%
% Answer: The command 'clear all' clears the variables in the Workspace
%
...
%
% Answer: ttest
%runs a ttest on data

% 8. What are the 2 major types of loops that MATLAB supports? What is the
% difference between them?

%
% Answer: while loop and for loop. A while repdeatly prodcues statements
% making a statment true. A for loop is a loop that produces a specific
% number of times. 
% 
...
fiveRandom = randi([-10 10],1,5);
subThree = fiveRandom - 3;
intgPos = length(nonzeros(subThree(subThree>0)));
abValue = abs(subThree);
findMax = max(abValue);
